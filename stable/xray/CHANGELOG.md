...
* Added README for supporting custom certificates to xray. Please refer [here](https://github.com/jfrog/charts/blob/master/stable/xray/README.md#establishing-tls-and-adding-certificates-to-xray-server)
