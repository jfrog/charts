...
Install JFrog Xray
```bash
helm upgrade --install xray --namespace xray center/jfrog/xray --version 2.4.4
```
...
```bash
# Update existing deployed version to 2.14.0
helm upgrade --install xray --namespace xray --set common.xrayVersion=2.14.0  center/jfrog/xray
```
