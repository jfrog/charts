...
--set artifactory.preStartCommand="wget -P /opt/jfrog/artifactory/tomcat/lib https://jcenter.bintray.com/mysql/mysql-connector-java/5.1.41/mysql-connector-java-5.1.41.jar" \
