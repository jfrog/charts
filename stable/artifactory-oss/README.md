...
```bash
helm upgrade --install artifactory-oss --namespace artifactory-oss center/jfrog/artifactory-oss --version 1.4.1
```
...
```bash
helm upgrade --install artifactory-oss --namespace artifactory-oss center/jfrog/artifactory-oss
```
