...
```bash
helm upgrade --install distribution --namespace distribution jfrog/distribution --version 4.1.0
```
...
helm upgrade --install distribution --namespace distribution --set replicaCount=3 jfrog/distribution
```
...
| `distribution.persistence.mountPath`            | Distribution persistence volume mount path                             | `"/var/opt/jfrog/distribution"`                                               |
