...
**At this time, for production-ready Artifactory installations it is recommended to use an external PostgreSQL with a static password. This is for performance and stability reasons**
