...
```bash
helm upgrade --install artifactory-ha --namespace artifactory-ha --set metrics.enabled=true --set metrics.serviceMonitor.enabled=false center/jfrog/artifactory-ha
```
